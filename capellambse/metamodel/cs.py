...
from . import capellacore, fa, information, interaction, modellingcore
...
class BlockArchitecture(fa.AbstractFunctionalArchitecture, abstract=True):
    ...
    capability_package = m.DeprecatedAccessor[
...
class Component(
    ...
    ports = m.Filter("owned_features", (ns.FA, "ComponentPort"))
    physical_ports = m.Filter("owned_features", (NS, "PhysicalPort"))
