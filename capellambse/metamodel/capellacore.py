...
class Structure(Namespace, abstract=True):
    ...
    property_value_packages = m.DeprecatedAccessor["PropertyValuePkg"](
        "property_value_pkgs"
    )
...
class AbstractPropertyValue(NamedElement, abstract=True):
    ...
    enumerations = m.DeprecatedAccessor["EnumerationPropertyType"](
...
class PropertyValueGroup(Namespace):
    ...
    values = m.DeprecatedAccessor["AbstractPropertyValue"]("property_values")
...
class PropertyValuePkg(Structure):
    ...
    packages = m.Alias["PropertyValuePkg"](
        "property_value_pkgs", dirhide=False
    )
    groups = m.Alias["PropertyValueGroup"](
        "property_value_groups", dirhide=False
    )
    values = m.Alias["AbstractPropertyValue"]("property_values", dirhide=False)
