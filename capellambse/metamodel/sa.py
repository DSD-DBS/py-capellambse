...
class SystemFunction(fa.AbstractFunction):
    ...
    functions = m.Containment["SystemFunction"](None, (NS, "SystemFunction"))
    realized_functions = m.Allocation["oa.OperationalActivity"](
        None, None, (ns.OA, "OperationalActivity")
    )
...
class Capability(interaction.AbstractCapability):
    ...
    realized_capabilities = m.Allocation["oa.OperationalCapability"](
        None, None, (ns.OA, "OperationalCapability")
    )
...
class SystemComponent(cs.Component, capellacore.InvolvedElement):
    ...
    realized_components = m.Allocation["oa.Entity"](
        None, None, (ns.OA, "Entity")
    )
