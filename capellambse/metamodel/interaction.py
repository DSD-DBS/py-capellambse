...
if t.TYPE_CHECKING:
    from . import capellacommon, information, modellingcore
...
if not t.TYPE_CHECKING:
    ...
    def __getattr__(name):
        ...
        if name == "AbstractInvolvement":
            warnings.warn(
                "AbstractInvolvement has been moved to capellacore.Involvement",
                DeprecationWarning,
                stacklevel=2,
            )
