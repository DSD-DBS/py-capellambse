...
m.ModelElement.constraints = m.Containment(
    "ownedConstraints", (ns.CAPELLACORE, "Constraint")
)
m.ModelElement.property_values = m.Containment(
    "ownedPropertyValues",
    (ns.CAPELLACORE, "AbstractPropertyValue"),
    mapkey="name",
    mapvalue="value",
)
m.ModelElement.property_value_groups = m.Containment(
...
class AbstractConstraint(ModelElement, abstract=True):
    ...
    constrained_elements = m.Association["ModelElement"](
        (NS, "ModelElement"), "constrainedElements"
    )
