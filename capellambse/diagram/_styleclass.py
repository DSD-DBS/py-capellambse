...
def get_style_class(obj: ModelObject) -> str:
    ...
    """
    try:
        return _STYLECLASSES[type(obj).__name__](obj)
    except KeyError:
        return _default(obj)
...
def _region(obj: ModelObject) -> str:
    ...
    if parent_xclass.startswith("State"):
        prefix = "State"
    elif parent_xclass == "Mode":
        prefix = "Mode"
    return f"{prefix}{_default(obj)}"
