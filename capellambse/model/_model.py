...
class MelodyModel:
        ...
        *clsnames: str | type[_obj.ModelObject] | _obj.UnresolvedClassName,
        ...
        clsnames
            ...
            - A Class object. It must have the ``__capella_namespace__``
              ...
              :class:`~capellambse.metamodel.capellamodeller.ModelElement`.

            .. note::

               This method treats the 'capellamodeller:ModelElement'
        ...
        return _obj.ElementList(self, elements, _obj.ModelElement)
    ...
    def resolve_class(
        self, typehint: str | _obj.UnresolvedClassName | etree.QName
    ) -> type[_obj.ModelObject]:
        """Resolve a class based on a type hint.

        The type hint can be one of:
