...
class DataType(
    ...
    min_inclusive = m.DeprecatedAccessor["t.Any"]("is_min_inclusive")
    max_inclusive = m.DeprecatedAccessor["t.Any"]("is_max_inclusive")
...
class BooleanType(DataType):
    ...
    default = m.DeprecatedAccessor["datavalue.AbstractBooleanValue"](
        "default_value"
    )
