...
#[pyfunction]
#[pyo3(signature=(tree, /, *, line_length, siblings, file = None))]
pub fn serialize<'py>(
    py: Python<'py>,
    tree: &'py Bound<PyAny>,
    line_length: usize,
...
mod tests {
    ...
    #[test]
    fn test_escaping() {
        let teststring = r#"	&Hello, <"World">!"#;
        assert_eq!(
            escape(teststring, EscapeCharset::Attribute),
            r#"&#x09;&amp;Hello, &lt;&quot;World&quot;>!"#
        );
        assert_eq!(
            escape(teststring, EscapeCharset::Text),
            r#"	&amp;Hello, &lt;&quot;World&quot;>!"#
        );
        assert_eq!(
            escape(teststring, EscapeCharset::Comment),
            r#"	&Hello, <"World"&gt;!"#,
        );
    }
}
